public class HeronsFormula {
  public static void main(String[] args) {
    ...
    System.out.println("A trinagle with sides 3,4,5 has area " + a);
  ...
  public static double triangleArea(int a, int b, int c) {
    ...
    // AFter cmputing the area, you must "return" the computed value;
    return A;
  }
  // The version that doesn't use a function is longer
}
